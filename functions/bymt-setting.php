...
$other_opts = array (
	...
	array( "tit" => "定义登陆界面样式","name" => "custom_login","desc" => '样式文件所在位置： <span style="color:#C30">BYMT/css/login.min.css</span>')
);
error_reporting(0);
?>
<link rel="stylesheet" type="text/css" href="<?php echo TPLDIR . '/css/setting.min.css'; ?>" />
<div class="bymt_setwrap">
	...
	?>
	<div class="bymt_setver">当前主题：<a href="http://www.yuxiaoxi.com/themes/bymt" target="_blank">BYMT</a> | 当前版本：<a href="http://www.yuxiaoxi.com/themes/bymt?version=2.1.1" target="_blank">2.1.1</a> | 最后更新：<a>2014.02.27</a> | 主题作者：<a href="http://www.yuxiaoxi.com/" target="_blank">麦田一根葱</a> | 赞助支持：<a href="http://me.alipay.com/yuxiaoxi" target="_blank">在支付宝上点个赞</a></div>
	<form method="post"  id="form1" action="options.php">
		...
		<div class="bymt_setbox">
			<ul class="nav">
				...
				<li class="version">BYMT 2.1.1</li>
			</ul>
			<ul id="bymt_config" data-warpversion="2.1.1" class="content loading">
...
<script src="<?php echo TPLDIR . '/js/setting.min.js'; ?>"></script>
<?php } ?>