...
*****/
    ...
    function bymt_widget0() {
        $widget_ops = array('description' => '本主题自带的最新文章、热评文章、随机文章小工具');
        $this->WP_Widget('bymt_widget0', 'BYMT-新热随文章', $widget_ops);
    }
...
//////////////////////////////////////////////////////////
    ...
    function bymt_widget1() {
        $widget_ops = array('description' => '本主题自带的最新评论小工具');
        $this->WP_Widget('bymt_widget1', 'BYMT-最新评论', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
		global $wpdb;
...
class bymt_widget2 extends WP_Widget {
    function bymt_widget2() {
        $widget_ops = array('description' => '本主题自带的评论排行榜小工具');
        $this->WP_Widget('bymt_widget2', 'BYMT-评论排行榜', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
		global $wpdb;
...
class bymt_widget3 extends WP_Widget {
    function bymt_widget3() {
        $widget_ops = array('description' => '本主题自带的站点统计小工具');
        $this->WP_Widget('bymt_widget3', 'BYMT-站点统计', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
		global $wpdb;
...
class bymt_widget4 extends WP_Widget {
    function bymt_widget4() {
        $widget_ops = array('description' => '主题自带的用户登录小工具');
        $this->WP_Widget('bymt_widget4', 'BYMT-用户登录', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
?>
...
class bymt_widget5 extends WP_Widget {
    function bymt_widget5() {
        $widget_ops = array('description' => '主题自带的侧边栏广告小工具 尺寸250*250');
        $this->WP_Widget('bymt_widget5', 'BYMT-侧边栏广告(大)', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
?>
...
class bymt_widget7 extends WP_Widget {
    function bymt_widget7() {
        $widget_ops = array('description' => '主题自带的侧边栏广告小工具 尺寸250*60');
        $this->WP_Widget('bymt_widget7', 'BYMT-侧边栏广告(中)', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
?>
...
class bymt_widget6 extends WP_Widget {
    function bymt_widget6() {
        $widget_ops = array('description' => '主题自带的侧边栏广告小工具 尺寸120*90*2');
        $this->WP_Widget('bymt_widget6', 'BYMT-侧边栏广告(小)', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
?>
...
class bymt_widget8 extends WP_Widget {
    function bymt_widget8() {
        $widget_ops = array('description' => '主题自带的侧边栏焦点图 尺寸260*110');
        $this->WP_Widget('bymt_widget8', 'BYMT-侧边栏焦点图', $widget_ops);
    }
    function widget($args, $instance) {
        extract($args);
?>
